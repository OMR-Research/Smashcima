...
DOCNAME=smashcima-technical-documentation
...
pandoc -s --resource-path=..\;../assets --extract-media=media/ --metadata title="Smashcima Technical Documentation" ../[0-9][0-9]_*.md -o ${DOCNAME}.html
